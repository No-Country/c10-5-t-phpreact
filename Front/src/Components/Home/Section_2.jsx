    ...
    return (
        ...
        <div className="flex flex-row w-full items-center justify-evenly py-[30px]">
            ...
            <div className="flex flex-col justify-evenly items-center bg-[#F4F4F4] w-[270px] h-[520px] rounded-[10px] shadow-dark">
                <div>
                    <img src="../../src/assets/diseñador.png" alt="profile" width={"180px"} height={"120px"}/>
                </div>
            ...
            <div className="flex flex-col justify-evenly items-center bg-[#F4F4F4] w-[270px] h-[520px] rounded-[10px] shadow-dark">
                <div>
                    <img src="../../src/assets/product_manager.png" alt="profile" width={"180px"} height={"120px"}/>
                </div>
            ...
            <div className="flex flex-col justify-evenly items-center bg-[#F4F4F4] w-[270px] h-[520px] rounded-[10px] shadow-dark">
                <div>
                    <img src="../../src/assets/frontend.png" alt="profile" width={"180px"} height={"120px"}/>
                </div>
            ...
            <div className="flex flex-col justify-evenly items-center bg-[#F4F4F4] w-[270px] h-[520px] rounded-[10px] shadow-dark">
                <div>
                    <img src="../../src/assets/backend.png" alt="profile" width={"180px"} height={"120px"}/>
                </div>
            ...
            <div className="flex flex-col justify-evenly items-center bg-[#F4F4F4] w-[270px] h-[520px] rounded-[10px] shadow-dark">
                <div>
                    <img src="../../src/assets/qa_tester.png" alt="profile" width={"180px"} height={"120px"}/>
                </div>
