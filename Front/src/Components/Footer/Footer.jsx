                ...
                <div className="flex flex-row w-full justify-between items-center">
                    <div className="flex flex-col h-full justify-between py-[20px]">
                        <div className="flex flex-row w-[300px] items-center" >
                            ...
                            <span className="font-Geogrotesque text-[34px] font-[600] text-white px-[10px] tracking-[-0.03em]">No Country</span>
                        </div>

                        <div>
                            <span className="font-Inter text-[15px] font-[500] text-text-color-white tracking-[-0.03em]">No Country ©2023.</span>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col justify-around items-center w-[615px] h-full">
                        ...
                        <div className="w-full">
                            <div className="w-1/2 flex flex-row items-center ml-auto">
                                <span className="font-Inter text-[16px] font-[500] text-text-color-white tracking-[-0.03em]  px-[20px]">info@nocountry.tech</span>
